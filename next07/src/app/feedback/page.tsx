...
export default function Feedback() {
    ...
    const content = (
        <form onSubmit={handleSubmit} className="flex flex-col mx-auto max-w-3xl p-6">
            ...
            <input
                className="p-3 mb-6 text-2xl rounded-2xl text-white border-solid border-white border-2"
                type="text"
                id="name"
                name="name"
                placeholder="Jane"
            ...
            <button
                className="p-3 mb-6 text-2xl rounded-2xl text-white border-solid border-white border-2 max-w-xs bg-grey hover:cursor-pointer disabled:hidden"
                disabled={!canSave}
            >Submit</button>
